...
{
    std::string up_w1 = word1;
	std::transform(up_w1.begin(), up_w1.end(), up_w1.begin(), toupper);
	std::string up_w2 = word2;
	std:: transform(up_w2.begin(), up_w2.end(), up_w2.begin(), toupper);
	auto w1 = dict.find(up_w1);
	auto w2 = dict.find(up_w2);
