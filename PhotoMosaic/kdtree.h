...
class KDTree
{
    ...
    private:
         ...
         */
      int  partition(  int lo, int hi,int n, int dim);
      void swap( int x, int y);
      void selection( int  lo, int hi, int n, int dim);
      void KDTreeHelper( int lo, int  hi, int dim);
      
      Point<Dim> findNearestNeighbor(const Point<Dim> & query, int lo, int hi, int dim) const;
